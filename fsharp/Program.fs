...
| Some "23a" -> input_lines |> Problem23.solve_a |> printfn "%d"
| Some "23b" -> input_lines |> Problem23.solve_b |> printfn "%d"
| Some "25a" -> input_lines |> Problem25.solve_a |> printfn "%s"
| _ -> printfn "Advent of Code 2022 (https://adventofcode.com)"
       printfn "Run: adventofcode2022 problem"
       printfn "     problem is one of 1a-11a,13a,15a,17a,19a,21a,23a,25a"
       printfn "                       1b-11b,13b,15b,17b,19b,21b,23b"
