...
| Some "17a" -> input_lines |> Problem17.solve_a |> printfn "%d"
| Some "17b" -> input_lines |> Problem17.solve_b |> printfn "%d"
| Some "19a" -> input_lines |> Problem19.solve_a |> printfn "%d"
| Some "19b" -> input_lines |> Problem19.solve_b |> printfn "%d"
| Some "21a" -> input_lines |> Problem21.solve_a |> printfn "%d"
| Some "21b" -> input_lines |> Problem21.solve_b |> printfn "%d"
| _ -> printfn "Advent of Code 2022 (https://adventofcode.com)"
       printfn "Run: adventofcode2022 problem"
       printfn "     problem is one of 1a-11a,13a,15a,17a,19a,21a; 1b-11b,13b,15b,17b,19b,21b"
